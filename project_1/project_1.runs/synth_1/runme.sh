...
HD_PWD='D:/Facultate/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_and_parallel_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_and_parallel_register.tcl
