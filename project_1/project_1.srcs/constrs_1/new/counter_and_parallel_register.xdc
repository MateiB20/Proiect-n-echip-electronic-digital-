...
set_property PACKAGE_PIN V2 [get_ports {reset_pr}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {reset_pr}]
set_property PACKAGE_PIN T3 [get_ports {x}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {x}]
set_property PACKAGE_PIN T2 [get_ports {y}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {y}]
set_property PACKAGE_PIN R3 [get_ports {reset_in}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {reset_in}]
set_property PACKAGE_PIN W2 [get_ports {ud_in}]					
